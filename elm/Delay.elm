    ...
    div [ class "card" ]
        ...
        , div [ class "delay" ]
            [ div [ class "delayparams" ]
                [ div [ class "labeledknob-horizontal" ] [ Html.map TimeMsg (Knob.view 30 model.time), text "Time" ]
                , div [ class "labeledknob-horizontal" ] [ Html.map FeedbackMsg (Knob.view 30 model.feedback), text "Feedback" ]
                ]
            ]
        ]
